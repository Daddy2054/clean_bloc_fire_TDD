...
// in clean_bloc_firebase/test/src/shared/app/blocs/app/app_bloc_test.dart.
...
class MockStreamAuthUserUseCase extends _i1.Mock
    implements _i3.StreamAuthUserUseCase {
  MockStreamAuthUserUseCase() {
  ...
  @override
  _i4.Stream<_i5.AuthUser> call() => (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
        ),
